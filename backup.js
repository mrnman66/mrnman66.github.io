(function() {
  ...
  function goExport() {
    showConfirmDialog(
      ...
      function() {
        ...
        // Упаковка данных в единый объект
        const data = {
          favorite: favorite,
          bookmarks: bookmarks,
          file_view: fileView,
        ...
        // Переключение на предыдущий компонент
          ...
          if (file) {
            ...
            reader.onload = function(e) {
              try {
                ...
                // Применяем новые данные в localStorage
                ...
                // Перезагрузка страницы для обновления интерфейса
                setTimeout(function() {
  ...
  function startPlugin() {
    ...
    Lampa.Lang.add({
      lampac_backup: {
        ru: 'Резервная копия', // Основной заголовок
        en: 'Full Backup',
