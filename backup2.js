(function() {
    ...
    Lampa.Select.show({
      ...
      onSelect: function(a, b) {
        if (a.export) {
          ...
          // Закрываем интерфейс через 500 мс — без уведомления об успехе
          setTimeout(function() {
  ...
  function goImport() {
    Lampa.Select.show({
      ...
      nomark: true,
      items: [
        { title: Lampa.Lang.translate('confirm'), import: true, selected: true },
        { title: Lampa.Lang.translate('cancel') }
      ],
      onSelect: function(a, b) {
        if (a.import) {
  ...
  function startPlugin() {
    ...
    Lampa.Lang.add({
      ...
      lampac_backup_export_success: {
        ru: 'Бэкап успешно сохранен',
        en: 'Backup successfully saved',
        uk: 'Резервна копія успішно збережена',
        zh: '备份成功保存'
      },
