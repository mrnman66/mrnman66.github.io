...
(function () {
    ...
    function anilibria2(component, _object) {
      ...
      var embed = 'https://aniliberty.top/api/v1/';
      var filter_items = {};
      var choice = {
        season: 0,
        voice: 0
    ...
    function component(object) {
      ...
      this.proxyStream = function (url, name) {
        if (url && use_stream_proxy) {
          ...
          if (stream_proxy_url) {
            if (!stream_proxy_url.endsWith('/')) stream_proxy_url += '/';
            return stream_proxy_url + url;
          }
    ...
    function initLang() {
      ...
      Lampa.Lang.add({
		...
		online_mod_stream_proxy_url: {
          ru: 'Адрес прокси для видеопотока',
          uk: 'Адреса проксі для відеопотоку',
          be: 'Адрас проксі для відэапаток',
          en: 'Video stream proxy URL',
          zh: '视频流代理 URL'
},
